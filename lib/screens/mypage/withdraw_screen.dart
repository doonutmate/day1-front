...
import 'package:day1/services/submit_reason.dart';
...
class _WithdrawScreenState extends State<WithdrawScreen> {
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    title: Text('기타', style: TextStyle(color: reason == '기타' ? Colors.purple : null)),
                    onTap: () {
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  onPressed: (reason != null && (reason != '기타' || otherReason.isNotEmpty))
                    ...
                    // 서버에 회원 탈퇴 이유 전송
                    bool success = await DioService.signOutDay1(oauthType, token, submitReasonText);
                  child: Text('탈퇴하기', style: TextStyle(color: Colors.white)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: reason != null && (reason != '기타' || otherReason.isNotEmpty) ? Colors.purple : Colors.grey,
  ...
  ListTile _buildReasonTile(BuildContext context, WidgetRef ref, String title) {
    final reason = ref.watch(reasonProvider);
    return ListTile(
      title: Text(title, style: TextStyle(color: reason == title ? Colors.purple : null)),
      onTap: () {
